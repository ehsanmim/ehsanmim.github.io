 ...
 *
 * The browser resolves the hash while the page is still an empty <div id="root">,
 * finds no such element, and gives up — so a shared deep link like /#experience
 * would otherwise always land at the top. Re-run it once the sections exist.
 */
